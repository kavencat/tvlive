    ...
    while len(result_urls) == 0 and timeout_cnt <= 5:
        try:
            ...
            if valid_ips:
                ...
                group_sctv = ["SCTV1","SCTV2","SCTV3","SCTV4","SCTV5","SCTV6","SCTV7","SCTV8","峨嵋电影","四川乡村高清"]
                group_cdtv = ["CDTV1","CDTV2","CDTV3","CDTV4","CDTV5","CDTV6","CDTV7","CDTV8"]
                ...
                with open(m3u_filename, 'w', encoding='utf-8') as output_file:
                    output_file.write('#EXTM3U  x-tvg-url="https://epg.112114.eu.org/pp.xml\n')  # 添加 #EXTM3U
                    for line in lines:
                        ...
                        if name1 in group_cctv:
                            ...
                            group_title = "卫视频道"
                        elif name1 in group_sctv:
                            group_title = "四川频道"
                        elif name1 in group_cdtv:
                            group_title = "成都频道"
                        else:
                            group_title = "其他频道"

                        output_file.write(f'#EXTINF:-1 tvg-id="{name1}" tvg-name="{name1}" tvg-logo="https://live.mxdyeah.top/logo/{name1}.png" group-title="{group_title}",{name2}\n{url}\n')
